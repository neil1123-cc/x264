...
#define AV_CH_LAYOUT_STEREO_DOWNMIX    (AV_CH_STEREO_LEFT|AV_CH_STEREO_RIGHT)
    ...
    else if( lsmash_check_codec_type_identical( p_audio->codec_type, ISOM_CODEC_TYPE_MP4A_AUDIO ) )
    {
        ...
        static const lsmash_qt_audio_channel_layout_t channel_table[] = {
            { QT_CHANNEL_LAYOUT_MONO,           (lsmash_channel_bitmap)AV_CH_LAYOUT_MONO },
            { QT_CHANNEL_LAYOUT_STEREO,         (lsmash_channel_bitmap)AV_CH_LAYOUT_STEREO },
            { QT_CHANNEL_LAYOUT_STEREO,         (lsmash_channel_bitmap)AV_CH_LAYOUT_STEREO_DOWNMIX },
            { QT_CHANNEL_LAYOUT_AAC_3_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_2_1 },
            { QT_CHANNEL_LAYOUT_AAC_3_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_SURROUND },
            { QT_CHANNEL_LAYOUT_AAC_4_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_4POINT0 },
            { QT_CHANNEL_LAYOUT_AAC_QUADRAPHONIC, (lsmash_channel_bitmap)AV_CH_LAYOUT_2_2 },
            { QT_CHANNEL_LAYOUT_AAC_QUADRAPHONIC, (lsmash_channel_bitmap)AV_CH_LAYOUT_QUAD },
            { QT_CHANNEL_LAYOUT_AAC_5_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_5POINT0 },
            { QT_CHANNEL_LAYOUT_AAC_5_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_5POINT0_BACK },
            { QT_CHANNEL_LAYOUT_AAC_5_1,        (lsmash_channel_bitmap)AV_CH_LAYOUT_5POINT1 },
            { QT_CHANNEL_LAYOUT_AAC_5_1,        (lsmash_channel_bitmap)AV_CH_LAYOUT_5POINT1_BACK },
            { QT_CHANNEL_LAYOUT_AAC_7_0,        (lsmash_channel_bitmap)AV_CH_LAYOUT_7POINT0 },
